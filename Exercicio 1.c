/* Escreva uma função que tem como parâmetros de entrada e saída três números inteiros, dia, mês e ano, representando uma data, e modifica esses inteiros de forma que eles representem o dia seguinte */
